...
export default function Collections() {
    return(
        <div className="max-w-full mx-auto px-6 py-16 bg-white">
            {/**Page Title */}
            <h1 className="text-xl sm:text-4xl md:text-4xl lg:text-4xl font-semibold text-center mt-12 mb-12 text-black tracking-widest">COLLECTIONS</h1>
            <p className="text-black text-center mb-9">Each collection is a narrative. A story told through fabric, form, and the audacious spirit of those who wear it. We do not follow trends—we create them.</p>
