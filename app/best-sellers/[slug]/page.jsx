...
import Link from "next/link";
    ...
    {id:1, name: "PRODUCT 1", price:"₦85,000", slug: "product1", img: "/c1.jpg"},
    {id:2, name: "PRODUCT 2", price:"₦95,000",  slug: "product2", img: "/c1.jpg"},
    {id:3, name: "PRODUCT 3", price:"₦90,000", slug: "product3", img: "/c1.jpg"},
    {id:4, name: "PRODUCT 4", price:"₦110,000", slug: "product4", img: "/c1.jpg"},
    {id:5, name: "PRODUCT 5", price:"₦120,000", slug: "product5", img: "/c1.jpg"},
    {id:6, name: "PRODUCT 6", price:"₦150,000", slug: "product6", img: "/c1.jpg"},
]
        ...
        <div className="w-full max-w-7xl mx-auto mt-10">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
                {filteredRelatedProducts.map((product)=>(
                    <Link key={product.id} href={`/best-sellers/${product.slug}`} className="text-black block h-full">
