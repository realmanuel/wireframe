...
const productsDemo =[
    { id:1, slug: "product1", name: "PRODUCT 1", img: "/c1.jpg",
        variants: [
            ...
            <div className="w-full max-w-full mx-auto  py-8 bg-white">
                ...
                <div className="flex flex-wrap gap-4 justify-start m-4">
                    {["Category", "Collection", "Size", "Price", "Color", "Sort By"].map(
                        (f)=>(
                            <button key={f} className="px-3 py-2 border text-sm bg-white text-black mb-8 hover:bg-black hover:text-white">
                                {f} ▼
                            </button>
                        )
                    )}
