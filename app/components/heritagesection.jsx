...
export default function HeritageSection() {
    return (
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-8 flex flex-col md:flex-row items-center justify-between gap-8 md:gap-12">
            ...
            <div className="w-full md:w-[42%] max-w-2xl text-left">
            ...
            <div className="relative h-64 sm:h-80 md:h-[28rem] w-full md:flex-1 md:min-w-0 overflow-hidden border-2 border-black bg-gray-200">
                <Image
                    src="/c1.jpg"
                    fill
