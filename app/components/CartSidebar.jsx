        ...
        >
            ...
            {cart.map((item, index) => (
                ...
                <div className="flex flex-col justify-between flex-1">
                    ...
                    <span className="text-black text-center border border-black w-4 sm:w-5">{item.quantity}</span>
            ...
            <button className="w-full border py-2 sm:py-3 text-xs sm:text-sm text-black">
                View Cart
            </button>

            <button className="w-full bg-white text-black py-2 sm:py-3 text-xs sm:text-sm border border-black">
                Checkout
            </button>
            </div>
        </div>
