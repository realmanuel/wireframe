...
export default function GiftCards() {
    ...
    return (
        <div className="w-full mt-0 min-h-screen justify-center items-start py-16 sm:py-20 md:py-28 bg-white text-black border-b-2 border-black overflow-x-hidden">
